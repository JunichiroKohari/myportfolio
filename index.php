...
<header class="l-header">
    <div class="c-header-description"><?php bloginfo( 'descripton' ) ?></div>
...
<footer class="l-footer">
    <div class="l-container">
        <p class="c-footer-description"><?php bloginfo( 'descripton' ) ?></p>
...
<div class="c-copyright">
    <p>Copyright © 2020 <?php bloginfo( 'name' ) ?> All Rights Reserved.</p>
</div>
<!-- ▲ フッター : 終了-->
<?php wp_footer(); ?>
</body>
